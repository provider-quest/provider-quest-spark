...
def process(minerPower, syntheticRegions, suffix=""):
    ...
    outputDir = os.environ.get('OUTPUT_POWER_SYNTHETIC_CSP_REGIONS_DIR') or \
        '../work/output' + suffix + '/miner_power/by_synthetic_csp_region'
    checkpointDir = os.environ.get('CHECKPOINT_POWER_SYNTHETIC_CSP_REGIONS_DIR') or \
        '../work/checkpoint' + suffix + '/miner_power/by_synthetic_csp_region'
